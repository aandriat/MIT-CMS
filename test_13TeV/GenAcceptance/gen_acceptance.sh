...
echo "Flatten Bacon"
root -l flatten_gen.C+\(\"flatten_bacon.conf\",\"/data/t3home000/aandriat/13TeV/ntuples\",0\) -q |& tee -a process_log.txt

echo "Calculate pdf acceptance uncertainty"
root -l pdf_uncertainty_acceptance.C+\(\"/data/t3home000/aandriat/13TeV/ntuples\",0\) -q |& tee -a process_log.txt
