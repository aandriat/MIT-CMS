...
curl -s --insecure https://cms-pdmv.cern.ch/mcm/public/restapi/requests/get_fragment/EXO-PhaseIFall16wmLHEGS-00003 --retry 2 --create-dirs -o Configuration/GenProduction/python/EXO-PhaseIFall16wmLHEGS-00003-fragment.py 
[ -s Configuration/GenProduction/python/SMP-RunIISummer15wmLHEGS-00128-fragment.py ] || exit $?;

scram b
cd ../../
cmsDriver.py Configuration/GenProduction/python/EXO-PhaseIFall16wmLHEGS-00003-fragment.py --fileout file:lhegensim.root --mc --eventcontent RAWSIM,LHE --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring,Configuration/GenProduction/randomizeSeeds.randomizeSeeds --datatier GEN-SIM,LHE --conditions MCRUN2_71_V1::All --beamspot Realistic50ns13TeVCollision --step LHE,GEN --magField 38T_PostLS1 --python_filename cmsRun_cfg.py --no_exec -n 1000 || exit $? ; 

echo "Made EXO Configuration"
