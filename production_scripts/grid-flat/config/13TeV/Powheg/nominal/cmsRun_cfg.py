...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EXO-PhaseIFall16wmLHEGS-00003-fragment.py nevts:1000'),
