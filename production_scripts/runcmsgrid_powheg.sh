...
echo " !!!!!! OH MY GOD THE RIGHT FILE IS RUNCMSGRID_POWHEG.SH !!!! "
...
then 
    ...
    echo -e "\ncomputing weights for 103 NNPDF3.0 nlo variations with alphas\n"
    iteration=292200
    lastfile=292302
    counter=2000
    while [ $iteration -le $lastfile ];
    ...
    echo -e "\ncomputing weights for 103 NNPDF3.1 nlo variations with alphas\n"
    iteration=303400
    lastfile=303500
    counter=3000
    while [ $iteration -le $lastfile ];
